...
const controllerPersonagem = require('./controller/personagem/controller_personagem.js')//EndPoints para a rota de Personagem
...
app.delete('/v1/locadora/ator/:id', cors(), async function (request, response) {
    ...
    //Chama a função para deletar o ator do BD
